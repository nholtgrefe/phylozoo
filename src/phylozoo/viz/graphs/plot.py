...
def plot_directed_multigraph(
    ...
    **layout_kwargs
    ...
    --------
    >>> from phylozoo.core.primitives.d_multigraph import DirectedMultiGraph
    >>> from phylozoo.viz.graphs import plot_directed_multigraph
    >>> G = DirectedMultiGraph(edges=[(1, 2), (2, 3)])
    >>> ax = plot_directed_multigraph(G, layout='circular')
    """
    return _plot_graph(graph, layout, style, backend, ax, show, **layout_kwargs)
...
def plot_mixed_multigraph(
    ...
    **layout_kwargs
    ...
    --------
    >>> from phylozoo.core.primitives.m_multigraph import MixedMultiGraph
    >>> from phylozoo.viz.graphs import plot_mixed_multigraph
