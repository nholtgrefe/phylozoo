...
def plot_network(
    ...
    **layout_kwargs
    ...
    --------
    >>> from phylozoo.core.network.dnetwork import DirectedPhyNetwork
    >>> from phylozoo.viz import plot_network
    >>>
...
def plot_tree(
    ...
    **layout_kwargs
    ...
    --------
    >>> from phylozoo.core.network.dnetwork import DirectedPhyNetwork
    >>> from phylozoo.viz import plot_tree
    >>>
    >>> tree = DirectedPhyNetwork(
    ...     edges=[(3, 1), (3, 2)],
    ...     nodes=[(1, {'label': 'A'}), (2, {'label': 'B'})]
    ...
    >>> ax = plot_tree(tree)
    """
    return plot_network(tree, layout=layout, style=style, backend=backend, ax=ax, show=show, **layout_kwargs)
