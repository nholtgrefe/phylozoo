...
def dgenerator_to_sdgenerator(d_generator: DirectedGenerator) -> SemiDirectedGenerator:
    ...
    if d_generator.level == 1:
        ...
        return SemiDirectedGenerator(MixedMultiGraph(undirected_edges=[(hybrid_node, hybrid_node)]))
    ...
    mixed_graph = MixedMultiGraph(directed_edges=directed_edges, undirected_edges=undirected_edges)
