...
FormatRegistry.register(
    DistanceMatrix, "phylip", reader=from_phylip, writer=to_phylip, extensions=[".phy", ".phylip"]
)

FormatRegistry.register(DistanceMatrix, "csv", reader=from_csv, writer=to_csv, extensions=[".csv"])
