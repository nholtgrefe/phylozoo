...
class TestFormatRegistry:
    ...
    def test_register_multiple_formats(self) -> None:
        ...
        FormatRegistry.register(
            TestClass, "format1", reader=reader1, writer=writer1, extensions=[".fmt1"]
        )

        FormatRegistry.register(
            TestClass, "format2", reader=reader2, writer=writer2, extensions=[".fmt2"]
        )
...
class TestIOMixin:
    ...
    def setup_method(self) -> None:
        ...
        FormatRegistry.register(
            TestNetwork, "format2", reader=from_format2, writer=to_format2, extensions=[".fmt2"]
        )
    ...
    def test_convert_string_with_kwargs(self) -> None:
        ...
        FormatRegistry.register(
            TestClass, "test", reader=reader, writer=writer, extensions=[".test"], default=True
        )

        result = TestClass.convert_string(
            "data", "test", "test", prefix="PREFIX:", suffix=":SUFFIX"
        )
