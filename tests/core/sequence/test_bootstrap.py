...
class TestBootstrap:
    ...
    def test_bootstrap_basic(self) -> None:
        ...
        sequences = {"taxon1": "ACGTACGT", "taxon2": "ACGTACGT", "taxon3": "ACGTACGT"}
        msa = MSA(sequences)
...
class TestBootstrapPerGene:
    ...
    def test_bootstrap_per_gene_multiple_genes(self) -> None:
        ...
        sequences = {"taxon1": "ACGTACGTACGT", "taxon2": "ACGTACGTACGT", "taxon3": "ACGTACGTACGT"}
        msa = MSA(sequences)
    ...
    def test_bootstrap_per_gene_gene_boundaries(self) -> None:
        ...
        sequences = {"taxon1": "AAAAACCC", "taxon2": "AAAAACCC", "taxon3": "AAAAACCC"}
        msa = MSA(sequences)
