...
class TestIsStackfreeNotStackfree:
    ...
    def test_is_stackfree_stacked_hybrids_simple(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                (9, 5),
                (9, 6),  # Root to tree nodes
                (5, 4),
                (5, 8),  # Tree node 5 to hybrid 4 and leaf 8
                (6, 4),
                (6, 10),  # Tree node 6 to hybrid 4 and leaf 10
                (4, 7),
                (9, 11),
                (11, 7),
                (11, 12),  # Hybrid 4 and tree node 11 lead to hybrid 7
    ...
    def test_is_stackfree_multiple_stacked_hybrids(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                (11, 5),
                (11, 6),  # Root to tree nodes
                (5, 4),
                (5, 12),  # Tree node 5 to hybrid 4 and leaf 12
                (6, 4),
                (6, 13),  # Tree node 6 to hybrid 4 and leaf 13
                (4, 7),
                (11, 14),
                (14, 7),
                (14, 15),  # Hybrid 4 and tree node 14 lead to hybrid 7
                (7, 9),
                (11, 16),
                (16, 9),
                (16, 17),  # Hybrid 7 and tree node 16 lead to hybrid 9
    ...
    def test_is_stackfree_mixed_stacked_and_non_stacked(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (4, 7),
                (14, 7),
                (14, 15),  # Hybrid 4 and tree node 14 lead to hybrid 7 (stacked)
                (7, 1),  # Hybrid 7 to leaf
                (14, 9),
                (11, 18),
                (18, 9),
                (18, 19),  # Tree node 14 and tree node 18 lead to hybrid 9 (not stacked)
...
class TestIsTreechild:
    ...
    def test_is_treechild_hybrid_with_tree_child(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (5, 9),
                (6, 4),
                (6, 10),  # Tree nodes lead to hybrid 4 and other nodes
    ...
    def test_is_treechild_hybrid_with_leaf_child(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (7, 6),  # Root to tree nodes
                (5, 4),
                (5, 1),  # Tree node 5 to hybrid 4 and leaf 1
                (6, 4),
                (6, 2),  # Tree node 6 to hybrid 4 and leaf 2
                (4, 3),  # Hybrid to leaf
            ],
            nodes=[(1, {"label": "A"}), (2, {"label": "B"}), (3, {"label": "C"})],
        )
    ...
    def test_is_treechild_tree_node_with_hybrid_and_tree_children(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (9, 6),  # Root to tree nodes
                (5, 4),
                (5, 8),  # Tree node 5 to hybrid 4 and tree node 8
                (6, 4),
                (6, 2),  # Tree node 6 to hybrid 4 and leaf 2
                (4, 1),
                (8, 3),
                (8, 10),  # Hybrid and tree node to leaves
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
    ...
    def test_is_treechild_not_treechild_all_hybrid_children(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (9, 6),  # Root to tree nodes
                (5, 4),
                (5, 7),  # Tree node 5 to hybrids 4 and 7
                (6, 4),
                (6, 7),  # Tree node 6 to hybrids 4 and 7
                (4, 1),
                (7, 2),  # Hybrids to leaves
            ],
    ...
    def test_is_treechild_not_treechild_root_all_hybrid_children(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (9, 10),
                (10, 4),
                (10, 7),  # Root also to tree node 10, which leads to hybrids
                (4, 1),
                (7, 2),  # Hybrids to leaves
            ],
            nodes=[(1, {"label": "A"}), (2, {"label": "B"})],
    ...
    def test_is_treechild_nested_hybrids_treechild(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                (10, 7),
                (10, 18),  # Root to tree nodes
                (7, 5),
                (7, 11),
                (18, 5),
                (18, 20),
                (18, 21),  # Both lead to hybrid 5 and other nodes
                (5, 6),  # Hybrid 5 to tree node 6
                (6, 4),
                (6, 12),
                (10, 14),
                (14, 4),
                (14, 23),  # Tree node 6 and tree node 14 lead to hybrid 4
                (4, 1),
                (11, 2),
                (11, 15),
                (11, 16),
                ...
                (12, 17),
                (20, 19),
                (20, 22),  # Hybrid and tree nodes to leaves
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
    ...
    def test_is_normal_treechild_without_shortcuts(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (6, 4),
                (6, 10),
                (10, 11),  # Tree nodes lead to hybrid 4 and other nodes
                (4, 8),  # Hybrid to tree node
                (8, 1),
                (8, 2),
                (9, 3),
    ...
    def test_is_normal_with_shortcut(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (6, 7),
                (7, 8),
                (7, 15),  # Tree nodes lead to hybrid 4
                (9, 4),
                (9, 11),
                (11, 12),
                (11, 13),  # This creates a shortcut: path 5 -> 9 -> 4 bypasses edge (5, 4)
                (4, 14),  # Hybrid to leaf
            ],
            nodes=[
                (8, {"label": "A"}),
    ...
    def test_is_normal_with_shortcut_longer_path(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (6, 7),
                (7, 8),
                (7, 19),  # Tree nodes lead to hybrid 4
                (9, 10),
                (10, 4),
                (9, 12),
                (12, 13),
                ...
                (10, 15),
                (15, 16),
                (15, 18),  # This creates a shortcut: path 5 -> 9 -> 10 -> 4 bypasses edge (5, 4)
                (4, 17),  # Hybrid to leaf
            ],
            nodes=[
                (8, {"label": "A"}),
    ...
    def test_is_normal_with_parallel_edges(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (6, 8),
                (8, 9),
                (8, 10),  # Parallel edges from 5 to 4
                (4, 11),
                (11, 12),
                (11, 13),  # Hybrid to leaf
            ],
            nodes=[
                (9, {"label": "A"}),
                (10, {"label": "B"}),
    ...
    def test_is_normal_multiple_hybrids_no_shortcuts(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (18, 5),
                (18, 20),
                (20, 21),  # Both lead to hybrid 5 and other nodes
                (5, 6),  # Hybrid 5 to tree node 6
                (6, 4),
                (6, 12),
                (10, 14),
                (14, 4),  # Tree node 6 and tree node 14 lead to hybrid 4
                (4, 1),
                (11, 2),
                (11, 15),
                (12, 3),
                (12, 17),
                (14, 23),
                (20, 24),  # Hybrid and tree nodes to leaves
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
    ...
    def test_is_galled_single_hybrid(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (5, 9),
                (6, 4),
                (6, 10),  # Both lead to hybrid 4 and other nodes
                (4, 8),  # Hybrid to tree node
                (8, 1),
                (8, 2),
                (9, 3),
    ...
    def test_is_galled_stacked_hybrids(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (5, 10),
                (6, 4),
                (6, 11),  # Both lead to hybrid 4 and other nodes
                (4, 7),
                ...
                (11, 13),
                (8, 14),
                (8, 15),  # Hybrid 7 and tree nodes to leaves
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
...
class TestIsUltrametric:
    ...
    def test_is_ultrametric_tree_equal_distances(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[{"u": 3, "v": 1, "branch_length": 1.0}, {"u": 3, "v": 2, "branch_length": 1.0}],
            nodes=[(1, {"label": "A"}), (2, {"label": "B"})],
        )
        assert is_ultrametric(net) is True
    ...
    def test_is_ultrametric_tree_different_distances(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[{"u": 3, "v": 1, "branch_length": 1.0}, {"u": 3, "v": 2, "branch_length": 2.0}],
            nodes=[(1, {"label": "A"}), (2, {"label": "B"})],
        )
