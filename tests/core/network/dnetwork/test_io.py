...
class TestDirectedPhyNetworkENewickIO:
    ...
    def test_round_trip_valid_hybrid(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (5, 4),
                (5, 8),  # Tree node 5 -> hybrid 4 and leaf 8
                (6, 4),
                (6, 9),  # Tree node 6 -> hybrid 4 and leaf 9
                (4, 10),  # Hybrid 4 -> tree node 10 (out-degree 1)
                (10, 1),
                (10, 2),  # Tree node 10 -> leaves
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
    ...
    def test_convert_string(self) -> None:
        ...
        result = DirectedPhyNetwork.convert_string(enewick_str, "enewick", "enewick")
...
class TestDirectedPhyNetworkDOTIO:
    ...
    def test_to_string_uses_labels_as_node_names(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "Species_A"}), (2, {"label": "Species_B"})]
        )
    ...
    def test_nodes_without_labels(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "A"}), 2]  # Node 2 has no label
        )
    ...
    def test_parallel_edges(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (3, 4, 0),
                (3, 4, 1),  # Two parallel edges from tree node to hybrid
    ...
    def test_dot_with_quoted_labels(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "Species A"}), (2, {"label": "Species-B"})]
        )
