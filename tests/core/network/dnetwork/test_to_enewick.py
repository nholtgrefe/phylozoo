...
class TestBranchLengths:
    ...
    def test_branch_lengths_mixed(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[{"u": 3, "v": 1, "branch_length": 0.5}, (3, 2)],  # No branch length
            nodes=[(1, {"label": "A"}), (2, {"label": "B"})],
        )
        result = to_enewick(net)
...
class TestHybridNodes:
    ...
    def test_single_hybrid_simple(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[
                ...
                (7, 6),
                (5, 4),
                (5, 8),  # Tree node 5 has out-degree 2
                (6, 4),
                (6, 9),  # Tree node 6 has out-degree 2
                (4, 10),  # Hybrid node 4 has out-degree 1
                (10, 1),
                (10, 2),  # Tree node 10 has out-degree 2
            ],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
    ...
    def test_multiple_hybrid_nodes(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(7, 5), (7, 6), (5, 3), (5, 4), (6, 3), (6, 4), (3, 1), (4, 2)],
            nodes=[(1, {"label": "A"}), (2, {"label": "B"})],
        )
        result = to_enewick(net)
...
class TestLabelQuoting:
    ...
    def test_label_with_spaces(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "Taxon A"}), (2, {"label": "B"})]
        )
        result = to_enewick(net)
    ...
    def test_label_with_parentheses(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "A(group1)"}), (2, {"label": "B"})]
        )
        result = to_enewick(net)
    ...
    def test_label_with_colon(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "A:1"}), (2, {"label": "B"})]
        )
        result = to_enewick(net)
    ...
    def test_label_with_quote(self) -> None:
        ...
        net = DirectedPhyNetwork(
            edges=[(3, 1), (3, 2)], nodes=[(1, {"label": "A'strain"}), (2, {"label": "B"})]
        )
        result = to_enewick(net)
...
class TestDeterministicOutput:
    ...
    def test_children_sorted_deterministically(self) -> None:
        ...
        net = DirectedPhyNetwork(
            ...
            nodes=[(3, {"label": "C"}), (5, {"label": "B"}), (7, {"label": "A"})],
        )
        result = to_enewick(net)
...
class TestRoundTrip:
    ...
    def test_hybrid_network_roundtrip(self) -> None:
        ...
        # Structure: root 7 -> (5, 6), 5 -> (4, 8), 6 -> (4, 9), 4 -> 10, 10 -> (1, 2)
        net = DirectedPhyNetwork(
            edges=[(7, 5), (7, 6), (5, 4), (5, 8), (6, 4), (6, 9), (4, 10), (10, 1), (10, 2)],
            nodes=[
                (1, {"label": "A"}),
                (2, {"label": "B"}),
                (8, {"label": "C"}),
