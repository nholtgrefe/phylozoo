...
class TestIsIsomorphic:
    ...
    def test_fixture_networks_same(self) -> None:
        ...
        assert (
            isomorphism.is_isomorphic(
                LEVEL_1_DNETWORK_SINGLE_HYBRID, LEVEL_1_DNETWORK_SINGLE_HYBRID
            )
            is True
        )
    ...
    def test_fixture_networks_different(self) -> None:
        ...
        assert (
            isomorphism.is_isomorphic(DTREE_SMALL_BINARY, LEVEL_1_DNETWORK_SINGLE_HYBRID) is False
        )
    ...
    def test_with_graph_attributes(self) -> None:
        ...
        assert isomorphism.is_isomorphic(net1, net2, graph_attrs=["version", "source"]) is True
    ...
    def test_hybrid_networks(self) -> None:
        ...
        net1 = DirectedPhyNetwork(
            edges=[(7, 5), (7, 6), (5, 4), (6, 4), (5, 8), (6, 9), (4, 1)],
            nodes=[(1, {"label": "A"}), (8, {"label": "B"}), (9, {"label": "C"})],
        )
        net2 = DirectedPhyNetwork(
            edges=[(12, 10), (12, 11), (10, 9), (11, 9), (10, 13), (11, 14), (9, 15)],
            nodes=[(15, {"label": "A"}), (13, {"label": "B"}), (14, {"label": "C"})],
        )
