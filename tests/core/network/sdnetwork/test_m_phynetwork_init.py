...
class TestNetworksWithHybrids:
    ...
    def test_multiple_hybrid_nodes(self) -> None:
        ...
        with expect_mixed_network_warning():
            net = MixedPhyNetwork(
                directed_edges=[(7, 5), (8, 5), (5, 4), (6, 4)],  # Hybrid node 5  # Hybrid node 4
                undirected_edges=[
                    (4, 1),
                    (6, 11),
                    (6, 12),
...
class TestParallelEdges:
    ...
    def test_parallel_undirected_edges(self) -> None:
        ...
        with expect_mixed_network_warning():
            net = MixedPhyNetwork(
                undirected_edges=[
                    (3, 4, 0),
                    (3, 4, 1),  # Two parallel edges between internal nodes
                    (3, 1),
                    (3, 2),
                    (4, 5),
                    (4, 6),
    ...
    def test_parallel_directed_edges_to_hybrid(self) -> None:
        ...
        with expect_mixed_network_warning():
            net = MixedPhyNetwork(
                directed_edges=[(5, 4, 0), (5, 4, 1), (6, 4)],  # Two parallel edges to hybrid 4
                undirected_edges=[(4, 2), (5, 8), (5, 10), (6, 9), (6, 11)],
                nodes=[
                    (2, {"label": "A"}),
                    (8, {"label": "B"}),
    ...
    def test_parallel_edges_dict_format(self) -> None:
        ...
        with expect_mixed_network_warning():
            net = MixedPhyNetwork(
                undirected_edges=[
                    (3, 4, 0),
                    (3, 4, 1),  # Parallel edges between internal nodes
                    (3, 1),
                    (3, 2),
                    (4, 5),
                    (4, 6),
...
class TestEdgeFormats:
    ...
    def test_mixed_format(self) -> None:
        ...
        with expect_mixed_network_warning():
            net = MixedPhyNetwork(
                undirected_edges=[(1, 2), {"u": 2, "v": 3, "branch_length": 0.5}, (2, 4)],
                nodes=[(1, {"label": "A"}), (3, {"label": "B"}), (4, {"label": "C"})],
            )
        assert net.number_of_edges() == 3
