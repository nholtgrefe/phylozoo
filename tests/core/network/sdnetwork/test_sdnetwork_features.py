    ...
    def test_cache_multiple_networks(self) -> None:
        ...
        net2 = SemiDirectedPhyNetwork(
            ...
            undirected_edges=[
                ...
                (5, 10),
                (6, 11),
            ],  # Same structure, different gammas
            nodes=[
                (2, {"label": "A"}),
                (8, {"label": "B"}),
                (10, {"label": "C"}),
...
class TestRootLocations:
    ...
    def test_network_with_directed_edges_exiting(self) -> None:
        ...
        net = SemiDirectedPhyNetwork(
            ...
            undirected_edges=[
                ...
                (5, 7),
                (5, 8),
                (5, 9),  # Node 5 has degree 4
                (6, 7),
                (6, 10),
                (6, 11),  # Node 6 has degree 4
        ...
        assert (
            len(undir_locs) >= 7
        )  # At least (5, 7), (5, 8), (5, 9), (6, 7), (6, 10), (6, 11), (7, 12)
    ...
    def test_parallel_undirected_edges(self) -> None:
        ...
        net = SemiDirectedPhyNetwork(
            undirected_edges=[
                (3, 1, 0),
                (3, 1, 1),  # Parallel edges (3, 1)
                (3, 2),
                (3, 4),
                (3, 5),  # Node 3 has degree 5
                (1, 6),
                (1, 7),  # Node 1 has degree 4 (2 parallel + 2 other)
            ],
            nodes=[
                (2, {"label": "B"}),
                (4, {"label": "C"}),
        ...
        assert (
            len(undir_locs) == 7
        )  # (3, 1, 0), (3, 1, 1), (3, 2, 0), (3, 4, 0), (3, 5, 0), (1, 6, 0), (1, 7, 0)
