...
class TestIsIsomorphic:
    ...
    def test_edge_attributes_undirected(self) -> None:
        ...
        G1 = MixedMultiGraph(
            undirected_edges=[{"u": 1, "v": 2, "weight": 1.0}, {"u": 2, "v": 3, "weight": 2.0}]
        )
        G2 = MixedMultiGraph(
            undirected_edges=[{"u": 4, "v": 5, "weight": 1.0}, {"u": 5, "v": 6, "weight": 2.0}]
        )
    ...
    def test_edge_attributes_directed(self) -> None:
        ...
        G1 = MixedMultiGraph(
            directed_edges=[{"u": 1, "v": 2, "weight": 1.0}, {"u": 2, "v": 3, "weight": 2.0}]
        )
        G2 = MixedMultiGraph(
            directed_edges=[{"u": 4, "v": 5, "weight": 1.0}, {"u": 5, "v": 6, "weight": 2.0}]
        )
    ...
    def test_edge_attributes_mismatch(self) -> None:
        ...
        G1 = MixedMultiGraph(undirected_edges=[{"u": 1, "v": 2, "weight": 1.0}])
        G2 = MixedMultiGraph(undirected_edges=[{"u": 3, "v": 4, "weight": 2.0}])  # Different weight
    ...
    def test_edge_attributes_ignored(self) -> None:
        ...
        G1 = MixedMultiGraph(undirected_edges=[{"u": 1, "v": 2, "weight": 1.0}])
        G2 = MixedMultiGraph(undirected_edges=[{"u": 3, "v": 4, "weight": 2.0}])
    ...
    def test_multiple_edge_attributes(self) -> None:
        ...
        G1 = MixedMultiGraph(undirected_edges=[{"u": 1, "v": 2, "weight": 1.0, "bootstrap": 0.95}])
        G2 = MixedMultiGraph(undirected_edges=[{"u": 3, "v": 4, "weight": 1.0, "bootstrap": 0.95}])
    ...
    def test_combined_attributes(self) -> None:
        ...
        G1 = MixedMultiGraph(
            undirected_edges=[{"u": 1, "v": 2, "weight": 1.0}], attributes={"version": "1.0"}
        )
        G1.add_node(1, label="A")
        G1.add_node(2, label="B")

        G2 = MixedMultiGraph(
            undirected_edges=[{"u": 3, "v": 4, "weight": 1.0}], attributes={"version": "1.0"}
        )
        ...
        assert (
            is_isomorphic(
                G1, G2, node_attrs=["label"], edge_attrs=["weight"], graph_attrs=["version"]
            )
            is True
        )
    ...
    def test_mixed_directed_undirected_complex(self) -> None:
        ...
        G1 = MixedMultiGraph(
            undirected_edges=[(1, 2), (2, 3)], directed_edges=[(3, 4), (4, 5), (5, 1)]
        )
        G2 = MixedMultiGraph(
            undirected_edges=[(6, 7), (7, 8)], directed_edges=[(8, 9), (9, 10), (10, 6)]
        )
    ...
    def test_mixed_directed_undirected_not_isomorphic(self) -> None:
        ...
        G1 = MixedMultiGraph(undirected_edges=[(1, 2)], directed_edges=[(2, 3)])
        G2 = MixedMultiGraph(
            undirected_edges=[(4, 5)], directed_edges=[(5, 6), (6, 7)]  # Extra edge
        )
    ...
    def test_complex_structure(self) -> None:
        ...
        G1 = MixedMultiGraph(undirected_edges=[(1, 2), (2, 3), (2, 4), (3, 5), (4, 5)])
        G2 = MixedMultiGraph(undirected_edges=[(6, 7), (7, 8), (7, 9), (8, 10), (9, 10)])
