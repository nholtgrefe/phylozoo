...
class TestIsIsomorphic:
    ...
    def test_edge_attributes_matching(self) -> None:
        ...
        G1 = DirectedMultiGraph(
            edges=[{"u": 1, "v": 2, "weight": 1.0}, {"u": 2, "v": 3, "weight": 2.0}]
        )
        G2 = DirectedMultiGraph(
            edges=[{"u": 4, "v": 5, "weight": 1.0}, {"u": 5, "v": 6, "weight": 2.0}]
        )
    ...
    def test_edge_attributes_mismatch(self) -> None:
        ...
        G1 = DirectedMultiGraph(edges=[{"u": 1, "v": 2, "weight": 1.0}])
        G2 = DirectedMultiGraph(edges=[{"u": 3, "v": 4, "weight": 2.0}])  # Different weight
    ...
    def test_edge_attributes_ignored(self) -> None:
        ...
        G1 = DirectedMultiGraph(edges=[{"u": 1, "v": 2, "weight": 1.0}])
        G2 = DirectedMultiGraph(edges=[{"u": 3, "v": 4, "weight": 2.0}])
    ...
    def test_multiple_edge_attributes(self) -> None:
        ...
        G1 = DirectedMultiGraph(edges=[{"u": 1, "v": 2, "weight": 1.0, "bootstrap": 0.95}])
        G2 = DirectedMultiGraph(edges=[{"u": 3, "v": 4, "weight": 1.0, "bootstrap": 0.95}])
    ...
    def test_combined_attributes(self) -> None:
        ...
        G1 = DirectedMultiGraph(
            edges=[{"u": 1, "v": 2, "weight": 1.0}], attributes={"version": "1.0"}
        )
        G1.add_node(1, label="A")
        G1.add_node(2, label="B")

        G2 = DirectedMultiGraph(
            edges=[{"u": 3, "v": 4, "weight": 1.0}], attributes={"version": "1.0"}
        )
    ...
    def test_parallel_edges_different_attributes(self) -> None:
        ...
        G1 = DirectedMultiGraph(
            edges=[{"u": 1, "v": 2, "weight": 1.0}, {"u": 1, "v": 2, "weight": 2.0}]
        )
        G2 = DirectedMultiGraph(
            edges=[
                {"u": 3, "v": 4, "weight": 1.0},
    ...
    def test_complex_structure(self) -> None:
        ...
        G1 = DirectedMultiGraph(edges=[(1, 2), (2, 3), (2, 4), (3, 5), (4, 5)])
        G2 = DirectedMultiGraph(edges=[(6, 7), (7, 8), (7, 9), (8, 10), (9, 10)])
