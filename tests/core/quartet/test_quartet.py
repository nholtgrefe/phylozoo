...
class TestQuartetMethods:
    ...
    def test_is_resolved(self, quartet_input: Split | set[int], expected_resolved: bool) -> None:
    ...
    def test_is_star(self, quartet_input: Split | set[int], expected_star: bool) -> None:
        """Test is_star method."""
        quartet = Quartet(quartet_input)
