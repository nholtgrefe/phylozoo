...
def _build_balanced_binary_tree(
    num_leaves: int,
...
def _create_simple_hybrid(
    ...
    edges = [
        (root_id, parent1_id),
        (root_id, parent2_id),  # Root to parents
        (parent1_id, hybrid_id),
        (parent2_id, hybrid_id),  # Parents to hybrid
...
DTREE_SINGLE_NODE = DirectedPhyNetwork(nodes=[(1, {"label": "A"})])
...
DTREE_NON_BINARY_LARGE = DirectedPhyNetwork(
    edges=[
        ...
        (23, 18),
        (24, 19),
        (24, 27),  # Node 24 now has out-degree 2
        (10, 1),
        (10, 2),
        (11, 3),
        (11, 25),
        ...
        (13, 28),
        (14, 6),
        (14, 29),  # Nodes 13, 14 now have out-degree 2
        (15, 7),
        (15, 30),
        (16, 8),
        (16, 31),  # Nodes 15, 16 now have out-degree 2
        (17, 9),
        (17, 32),
        (18, 33),
        (18, 34),
        (19, 35),
        (19, 36),  # Nodes 17, 18, 19 have out-degree 2
    ],
...
LEVEL_1_DNETWORK_SINGLE_HYBRID = DirectedPhyNetwork(
    edges=[
        ...
        (5, 4),
        (6, 4),  # Both lead to hybrid 4 (in-degree 2)
        (4, 8),  # Hybrid to tree node
        (8, 1),
        (8, 2),  # Tree node to leaves
        (5, 3),
        (6, 7),  # Additional leaves to satisfy degree constraints
    ],
...
LEVEL_1_DNETWORK_SINGLE_HYBRID_BINARY = DirectedPhyNetwork(
    edges=[(8, 5), (8, 6), (5, 4), (6, 4), (4, 7), (5, 1), (6, 2), (7, 3), (7, 9)],
...
LEVEL_2_DNETWORK_TWO_HYBRIDS_SAME_BLOB = DirectedPhyNetwork(
    edges=[
        ...
        (11, 8),  # First hybrid
        (8, 9),
        (10, 9),  # Second hybrid (receives from 8 and 10)
        (9, 12),  # Tree node
        (12, 1),
        (12, 2),  # Leaves
        (11, 3),
        (15, 4),  # Additional leaves
    ],
...
LEVEL_2_DNETWORK_TRIANGLE_HYBRID = DirectedPhyNetwork(
    edges=[
        (7, 5),
        (7, 6),  # Root to two nodes
        (5, 4),
        (6, 4),  # Both to hybrid (forms triangle with edge below)
        (5, 6),  # Edge making triangle
        (4, 9),  # Hybrid to tree node
        (9, 1),
        (9, 2),  # Tree node to leaves
        (7, 3),  # Extra leaf
    ],
...
LEVEL_2_DNETWORK_NESTED_HYBRIDS = DirectedPhyNetwork(
    edges=[
        ...
        (13, 10),
        (13, 11),  # Tree node splits
        (10, 8),
        (11, 8),  # Hybrid 8
        (8, 9),  # Hybrid to tree node
        (9, 5),
        (9, 6),  # Tree node splits
...
LEVEL_2_DNETWORK_DIAMOND_HYBRID = DirectedPhyNetwork(
    edges=[
        (10, 7),
        (10, 8),
        (10, 11),  # Root with out-degree 3
        (7, 5),
        (8, 5),  # Hybrid 5 from 7,8
        (5, 12),  # Hybrid 5 to tree node 12
        (12, 1),
        (12, 2),  # Tree node 12 to leaves
        (7, 6),
        (8, 6),
        (11, 6),  # Hybrid 6 from 7,8,11
        (6, 13),  # Hybrid 6 to tree node 13
        (13, 3),
        (13, 4),  # Tree node 13 to leaves
        (11, 14),
        (11, 15),  # Node 11 to additional leaves (now out-degree 3)
    ],
    nodes=[
        (1, {"label": "A"}),
        (2, {"label": "B"}),
...
LEVEL_1_DNETWORK_TWO_BLOBS = DirectedPhyNetwork(
    edges=[
        ...
        (4, 14),
        (14, 1),
        (14, 16),  # Hybrid to tree node with 2 children
        # Bridge
        (6, 11),
        ...
        (9, 15),
        (15, 2),
        (15, 17),  # Hybrid to tree node with 2 children
        # Extra leaves
        (5, 3),
        (7, 12),
        (8, 13),
...
LEVEL_2_DNETWORK_THREE_BLOBS = DirectedPhyNetwork(
    edges=[
        ...
        (15, 28),
        (28, 1),
        (28, 32),  # Hybrid to tree with 2 children
        # Bridge to blob 2
        (21, 25),
        ...
        (29, 17),
        (29, 34),
        (22, 17),  # Tree node (with 2 children) and parent to hybrid 17
        (17, 31),
        (31, 2),
        (31, 33),  # Hybrid 17 to tree with 2 children
        # Bridge to blob 3
        (23, 26),
        ...
        (20, 5),
        (30, 6),
        (26, 7),  # Added leaf to node 26 (now out-degree 2)
    ],
    nodes=[
        (1, {"label": "A"}),
        (2, {"label": "B"}),
...
LEVEL_1_DNETWORK_CHAIN_OF_BLOBS = DirectedPhyNetwork(
    edges=[
        ...
        (10, 14),
        (14, 1),
        (14, 18),  # Hybrid to tree (with 2 children)
        (18, 30),
        (18, 32),  # Tree continues to bridge and has 2 children
        (30, 22),
        (30, 23),
        (22, 11),
        (23, 11),  # Hybrid 11
        (11, 15),
        (15, 3),
        (15, 19),  # Hybrid to tree (with 2 children)
        (19, 40),
        (19, 33),  # Tree continues to bridge and has 2 children
        (40, 24),
        (40, 25),
        (24, 12),
        (25, 12),  # Hybrid 12
        (12, 16),
        (16, 4),
        (16, 29),  # Hybrid to tree (with 2 children)
        (29, 46),
        (29, 34),  # Tree continues to bridge and has 2 children
        (46, 27),
        (46, 28),
        (27, 13),
        (28, 13),  # Hybrid 13
        (13, 17),
        (17, 5),
        (17, 31),  # Hybrid to tree (with 2 children)
    ...
    nodes=[(i, {"label": f"L{i}"}) for i in range(1, 7)]
    + [(i, {"label": f"X{i}"}) for i in range(35, 42)],
)
...
LEVEL_2_DNETWORK_SINGLE_BLOB = DirectedPhyNetwork(
    edges=[
        ...
        (25, 20),
        (25, 22),
        (26, 20),  # Node 25 branches (to hybrid 20 and leaf 22)
        (20, 27),  # Hybrid 20 to tree node 27
        (27, 18),
        (27, 19),  # Tree node 27 splits
        (18, 15),
        (18, 21),
        (19, 15),  # Tree node 18 branches (to hybrid 15 and leaf 21)
        (15, 28),  # Hybrid 15 to tree node 28
        (28, 12),
        (28, 13),  # Tree node 28 splits
        (12, 10),
        (13, 10),  # Hybrid 10
        (10, 29),  # Hybrid 10 to tree node 29
        (29, 8),
        (29, 23),
        (12, 8),  # Tree node 29 branches (to hybrid 8 and leaf 23)
        (8, 31),  # Hybrid 8 to tree node 31
        (31, 1),
        (31, 2),  # Tree node 31 to leaves
        (13, 3),
        (19, 4),
        (26, 5),  # More leaves
    ],
    nodes=[(i, {"label": f"L{i}"}) for i in range(1, 6)]
    + [(21, {"label": "L6"}), (22, {"label": "L7"}), (23, {"label": "L8"})],
)
...
LEVEL_2_DNETWORK_MULTIPLE_BLOBS = DirectedPhyNetwork(
    edges=[
        ...
        (60, 31),
        (60, 32),  # Tree node 60 splits
        (31, 20),
        (31, 11),
        (32, 20),  # Node 31 branches
        (20, 61),  # Hybrid 20 to tree node 61
        (61, 21),
        (61, 16),
        (31, 21),  # Tree node 61 branches, hybrid 21
        (21, 66),  # Hybrid 21 to tree node 66
        (66, 62),
        (66, 7),  # Tree node 66 branches
        (62, 1),
        (62, 17),  # Tree node 62 branches
        # Bridge
        (32, 45),
        ...
        (63, 34),
        (63, 35),  # Tree node 63 splits
        (41, 12),
        (43, 13),  # Nodes 41, 43 branch
        (34, 22),
        (34, 68),
        (35, 22),
        (35, 6),  # Nodes 34, 35 branch (use 68 instead of 5)
        (22, 64),  # Hybrid 22 to tree node 64
        (64, 23),
        (64, 14),
        (34, 23),  # Tree node 64 branches, hybrid 23
        (23, 67),  # Hybrid 23 to tree node 67
        (67, 65),
        (67, 8),  # Tree node 67 branches
        (65, 2),
        (65, 15),  # Tree node 65 branches
        # Extra leaves
        (40, 3),
        (41, 9),
        (42, 4),
...
LEVEL_3_DNETWORK_HIGH_VERTEX_LEVEL = DirectedPhyNetwork(
    edges=[
        (50, 40),
        (50, 41),
        (50, 42),  # Root with out-degree 3
        (40, 30),
        (41, 30),
        (41, 7),
        (42, 30),  # Node 41 branches
        (30, 60),  # Hybrid 30 to tree node 60
        (60, 31),
        (60, 32),  # Tree node 60 splits
        (31, 20),
        (32, 20),
        (40, 20),  # Hybrid 20 with in-degree 3
        (20, 61),  # Hybrid 20 to tree node 61
        (61, 21),
        (61, 22),  # Tree node 61 splits
        (21, 10),
        (21, 5),
        (22, 10),
        (22, 6),
        (31, 10),  # Nodes 21, 22 branch (to hybrid 10 and leaves)
        (10, 62),  # Hybrid 10 to tree node 62
        (62, 1),
        (62, 2),  # Tree node 62 to leaves
        (32, 3),
        (42, 4),  # More leaves
    ],
    nodes=[
...
LEVEL_2_DNETWORK_PARALLEL_HYBRIDS = DirectedPhyNetwork(
    edges=[
        ...
        (20, 15),
        (21, 15),
        (22, 15),  # Hybrid 15 (in-degree 3)
        (15, 50),  # Hybrid 15 to tree node 50
        (50, 16),
        (50, 17),  # Tree node 50 splits
        (16, 10),
        (16, 5),
        (17, 10),
        (17, 6),
        (20, 10),  # Nodes 16, 17 branch (to hybrid 10 and leaves)
        (10, 51),  # Hybrid 10 to tree node 51
        (51, 1),
        (51, 2),  # Tree node 51 to leaves
        (21, 3),
        (22, 4),  # More leaves
    ],
    nodes=[
...
LEVEL_3_DNETWORK_LARGE_MANY_HYBRIDS = DirectedPhyNetwork(
    edges=_large_many_hybrids_edges, nodes=_large_many_hybrids_nodes
)
...
LEVEL_1_DNETWORK_LARGE_FEW_HYBRIDS = DirectedPhyNetwork(
    edges=_large_few_hybrids_edges, nodes=_large_few_hybrids_nodes
)
...
for blob_idx in range(4):
    ...
    _blob_edges.extend(
        [
            (base + 15, base + 10),
            (base + 15, base + 11),  # Parents to hybrid 8
            (base + 10, base + 8),
            (base + 11, base + 8),  # Hybrid 8
            (base + 8, base + 12),  # Hybrid to tree node 12
            (base + 12, base + 1),
            (base + 12, base + 4),  # Tree node 12 branches (to 2 leaves)
            (base + 10, base + 2),
            (base + 11, base + 3),  # Parent nodes to extra leaves
        ]
    )
    _blob_nodes.extend(
        [
...
LEVEL_1_DNETWORK_LARGE_DEEP_HYBRID_CHAIN = DirectedPhyNetwork(
    edges=[
        ...
        (90, 80),
        (91, 80),
        (91, 24),  # Node 91 branches
        (80, 101),
        (101, 81),
        (101, 82),
        (101, 9),  # Hybrid 80 -> tree 101 -> nodes (add leaf)
        (81, 70),
        (81, 22),
        (82, 70),
        (82, 23),  # Nodes 81, 82 branch
        (70, 102),
        (102, 71),
        (102, 72),
        (102, 10),  # Hybrid 70 -> tree 102 -> nodes (add leaf)
        (71, 60),
        (71, 20),
        (72, 60),
        (72, 21),  # Nodes 71, 72 branch
        (60, 103),
        (103, 61),
        (103, 62),
        (103, 11),  # Hybrid 60 -> tree 103 -> nodes (add leaf)
        (61, 50),
        (61, 18),
        (62, 50),
        (62, 19),  # Nodes 61, 62 branch
        (50, 104),
        (104, 51),
        (104, 52),
        (104, 12),  # Hybrid 50 -> tree 104 -> nodes (add leaf)
        (51, 40),
        (51, 16),
        (52, 40),
        (52, 17),  # Nodes 51, 52 branch
        (40, 105),
        (105, 41),
        (105, 42),
        (105, 13),  # Hybrid 40 -> tree 105 -> nodes (add leaf)
        (41, 30),
        (41, 14),
        (42, 30),
        (42, 15),  # Nodes 41, 42 branch
        (30, 106),
        (106, 1),
        (106, 2),  # Hybrid 30 -> tree 106 -> leaves
        (90, 3),
        (81, 4),
        (71, 5),
        (61, 6),
...
LEVEL_1_DNETWORK_PARALLEL_EDGES_HYBRID = DirectedPhyNetwork(
    edges=[
        ...
        (15, 11),
        (10, 8, 0),
        (10, 8, 1),  # Parallel edges to hybrid
        (11, 8, 0),
        (11, 8, 1),  # More parallel edges to same hybrid
        (8, 9),  # Hybrid to tree node
        (9, 5),
        (9, 6),  # Tree node branches
        (5, 1),
        (5, 2),
        (10, 3),
        (11, 4),
...
LEVEL_2_DNETWORK_MANY_PARALLEL_EDGES = DirectedPhyNetwork(
    edges=[
        (20, 15, 0),
        (20, 15, 1),
        (20, 15, 2),  # Triple parallel to hybrid 15
        (20, 16),
        (15, 25),  # Hybrid 15 to tree node 25
        (25, 10, 0),
        (25, 10, 1),  # Tree node 25 to hybrid 10 (double parallel)
        (16, 10, 0),
        (16, 10, 1),  # Double parallel to hybrid
        (10, 11),  # Hybrid 10 to tree node
        (11, 5),
        (11, 7),  # Tree node branches
        (5, 1),
        (5, 2),
        (25, 3),
        (16, 4),  # Tree node 25 and node 16 to leaves
    ],
    nodes=[
        (1, {"label": "A"}),
        (2, {"label": "B"}),
...
LEVEL_1_DNETWORK_PARALLEL_IN_BLOB = DirectedPhyNetwork(
    edges=[
        ...
        (20, 16),
        (15, 12, 0),
        (15, 12, 1),  # Parallel within blob
        (16, 12, 0),
        (16, 12, 1),  # More parallel to hybrid
        (12, 13),  # Hybrid to tree node
        (13, 10, 0),
        (13, 10, 1),  # Parallel from tree node to hybrid 10
        (10, 11),  # Hybrid 10 to tree node 11
        (11, 1),
        (11, 2),  # Tree node 11 to leaves
        (15, 3),
        (16, 4),
    ],
    nodes=[(1, {"label": "A"}), (2, {"label": "B"}), (3, {"label": "C"}), (4, {"label": "D"})],
...
LEVEL_3_DNETWORK_CHAIN_HYBRIDS = DirectedPhyNetwork(
    edges=[
        ...
        (30, 60),  # Hybrid 30 to tree node 60
        (60, 31),
        (60, 4),  # Tree node 60 branches (not pass-through)
        (31, 20),
        (40, 20),  # Hybrid 20 (31 and 40)
        (20, 61),  # Hybrid 20 to tree node 61
        (61, 21),
        (61, 5),  # Tree node 61 branches (not pass-through)
        (21, 10),
        (21, 7),
        (31, 10),  # Node 21 branches (to hybrid 10 and leaf 7)
        (10, 62),  # Hybrid 10 to tree node 62
        (62, 1),
        (62, 2),  # Tree node 62 to leaves
        (41, 3),
    ...
    nodes=[
        (i, {"label": f"L{i}"}) for i in [1, 2, 3, 4, 5, 7]
    ],  # Leaves: 1, 2, 3, 4, 5, 7 (6 not used)
)
...
def get_networks_by_category(category: str) -> list[DirectedPhyNetwork]:
    ...
    True
    """
    return [globals()[k] for k, v in NETWORK_METADATA.items() if v["category"] == category]
