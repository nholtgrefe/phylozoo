...
SDTREE_SINGLE_NODE = SemiDirectedPhyNetwork(nodes=[(1, {"label": "A"})])
...
LEVEL_1_SDNETWORK_SINGLE_HYBRID_BINARY = SemiDirectedPhyNetwork(
    directed_edges=[(5, 4), (6, 4)],
    undirected_edges=[(5, 1), (5, 6), (6, 2), (4, 7), (7, 3), (7, 9)],
...
LEVEL_1_SDNETWORK_TWO_HYBRIDS_SEPARATE = SemiDirectedPhyNetwork(
    directed_edges=[(5, 4), (6, 4), (7, 9), (8, 9)],
    undirected_edges=[(5, 11), (5, 6), (11, 7), (11, 8), (6, 3), (7, 12), (8, 13), (4, 1), (9, 2)],
    nodes=[
        (3, {"label": "C"}),
        (1, {"label": "A"}),
        (12, {"label": "D"}),
...
LEVEL_2_SDNETWORK_DIAMOND_HYBRID = SemiDirectedPhyNetwork(
    directed_edges=[(7, 5), (7, 6), (8, 5), (8, 6), (11, 6)],
    undirected_edges=[
        (10, 7),
        (10, 8),
        (10, 11),
...
LEVEL_2_SDNETWORK_NESTED_HYBRIDS = SemiDirectedPhyNetwork(
    directed_edges=[(15, 12), (16, 12), (10, 8), (10, 7), (11, 8), (5, 7)],
    undirected_edges=[
        (15, 21),
        (15, 16),
        (21, 22),
...
LEVEL_2_SDNETWORK_TRIANGLE_HYBRID = SemiDirectedPhyNetwork(
    directed_edges=[(7, 6), (5, 4), (5, 6), (6, 4)],
    undirected_edges=[(7, 5), (7, 3), (4, 9), (9, 1), (9, 2)],
    nodes=[(3, {"label": "C"}), (1, {"label": "A"}), (2, {"label": "B"})],
)
...
LEVEL_2_SDNETWORK_TWO_HYBRIDS_SAME_BLOB = SemiDirectedPhyNetwork(
    directed_edges=[(10, 8), (10, 9), (11, 8), (8, 9)],
    undirected_edges=[(15, 10), (15, 11), (15, 4), (11, 3), (9, 12), (12, 1), (12, 2)],
    nodes=[(4, {"label": "D"}), (3, {"label": "C"}), (1, {"label": "A"}), (2, {"label": "B"})],
)
...
LEVEL_1_SDNETWORK_CHAIN_OF_BLOBS = SemiDirectedPhyNetwork(
    directed_edges=[(20, 10), (21, 10), (22, 11), (23, 11), (24, 12), (25, 12), (27, 13), (28, 13)],
    undirected_edges=[
        (20, 2),
        (20, 21),
        (21, 35),
...
LEVEL_1_SDNETWORK_STAR_BLOBS = SemiDirectedPhyNetwork(
    directed_edges=[(51, 40), (52, 40), (61, 41), (62, 41), (71, 42), (72, 42), (81, 43), (82, 43)],
    undirected_edges=[
        (100, 50),
        (100, 60),
        (100, 70),
...
LEVEL_2_SDNETWORK_THREE_BLOBS = SemiDirectedPhyNetwork(
    directed_edges=[(20, 15), (21, 15), (22, 16), (22, 17), (23, 16), (29, 17)],
    undirected_edges=[
        (30, 20),
        (30, 21),
        (30, 6),
...
LEVEL_2_SDNETWORK_PARALLEL_HYBRIDS = SemiDirectedPhyNetwork(
    directed_edges=[(20, 15), (20, 10), (21, 15), (22, 15), (16, 10), (17, 10)],
    undirected_edges=[
        (30, 20),
        (30, 21),
        (30, 22),
...
LEVEL_2_SDNETWORK_SINGLE_BLOB = SemiDirectedPhyNetwork(
    directed_edges=[(25, 20), (26, 20), (18, 15), (19, 15), (12, 10), (12, 8), (13, 10), (29, 8)],
    undirected_edges=[
        (25, 22),
        (25, 26),
        (26, 5),
...
LEVEL_1_SDNETWORK_LARGE_FEW_HYBRIDS = SemiDirectedPhyNetwork(
    directed_edges=[(31, 1054), (32, 1054), (34, 1055), (35, 1055)],
    undirected_edges=[
        (31, 1),
        (31, 2),
        (31, 46),
...
LEVEL_1_SDNETWORK_LARGE_GLUED = SemiDirectedPhyNetwork(
    directed_edges=[(100, 90), (101, 90), (104, 95), (105, 95)],
    undirected_edges=[
        (100, 2),
        (100, 101),
        (101, 110),
...
LEVEL_1_SDNETWORK_LARGE_MULTI_BLOB = SemiDirectedPhyNetwork(
    directed_edges=[(10, 8), (11, 8), (30, 28), (31, 28), (50, 48), (51, 48), (70, 68), (71, 68)],
    undirected_edges=[
        (15, 10),
        (15, 11),
        (15, 35),
...
LEVEL_1_SDNETWORK_PARALLEL_EDGES = SemiDirectedPhyNetwork(
    directed_edges=[(10, 5), (10, 5, 1)],
    undirected_edges=[(10, 6), (6, 3), (6, 4), (5, 11), (11, 1), (11, 2)],
    nodes=[(3, {"label": "C"}), (4, {"label": "D"}), (1, {"label": "A"}), (2, {"label": "B"})],
)
...
LEVEL_1_SDNETWORK_PARALLEL_EDGES_HYBRID = SemiDirectedPhyNetwork(
    directed_edges=[(10, 8), (10, 8, 1), (11, 8), (11, 8, 1)],
    undirected_edges=[(10, 3), (10, 11), (11, 4), (8, 9), (9, 5), (9, 6), (5, 1), (5, 2)],
    nodes=[
        (3, {"label": "C"}),
        (4, {"label": "D"}),
        (6, {"label": "E"}),
...
LEVEL_1_SDNETWORK_PARALLEL_IN_BLOB = SemiDirectedPhyNetwork(
    directed_edges=[(15, 12), (15, 12, 1), (16, 12), (16, 12, 1), (13, 10), (13, 10, 1)],
    undirected_edges=[(15, 3), (15, 16), (16, 4), (12, 13), (10, 11), (11, 1), (11, 2)],
    nodes=[(3, {"label": "C"}), (4, {"label": "D"}), (1, {"label": "A"}), (2, {"label": "B"})],
)
...
LEVEL_1_SDNETWORK_MIXED_TOPOLOGY = SemiDirectedPhyNetwork(
    directed_edges=[(81, 71), (82, 71), (51, 40), (52, 40)],
    undirected_edges=[
        (100, 80),
        (100, 81),
        (100, 82),
...
LEVEL_1_SDNETWORK_NON_LSA = SemiDirectedPhyNetwork(
    directed_edges=[(5, 4), (6, 4)],
    undirected_edges=[(10, 5), (10, 6), (10, 136), (5, 3), (6, 7), (4, 8), (8, 1), (8, 2)],
    nodes=[
        (136, {"label": "E"}),
        (3, {"label": "C"}),
        (7, {"label": "D"}),
...
LEVEL_3_SDNETWORK_CHAIN_HYBRIDS = SemiDirectedPhyNetwork(
    directed_edges=[(40, 30), (40, 20), (41, 30), (31, 20), (31, 10), (21, 10)],
    undirected_edges=[
        (40, 41),
        (41, 3),
        (30, 60),
...
SDTREE_SIMPLE = SemiDirectedPhyNetwork(
    undirected_edges=[(15, 1), (15, 2), (15, 3)],
