"""
Tests for backend system in visualize2.
...
from phylozoo.visualize.dnetwork.backends import (
    Backend,
    get_backend,
    register_backend,
)
...
class TestBackendRegistry:
    ...
    def test_matplotlib_backend_registered(self) -> None:
        ...
        from phylozoo.visualize.dnetwork.backends import matplotlib  # noqa: F401
...
class TestMatplotlibBackend:
    ...
    def test_create_figure(self) -> None:
        ...
        from phylozoo.visualize.dnetwork.backends import get_backend
