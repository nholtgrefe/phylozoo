...
and analysis capabilities for :class:`~phylozoo.core.network.sdnetwork.sd_phynetwork.SemiDirectedPhyNetwork`. This page covers network features,
...
which are nodes with every child being a hybrid node. This function is not yet implemented.
...
semi-directed network to a :class:`~phylozoo.core.network.dnetwork.base.DirectedPhyNetwork` by orienting all undirected edges away from a root.
...
around :func:`~phylozoo.core.network.sdnetwork.derivations.to_d_network`).
...
- :doc:`API Reference <../../../../api/core/network/sdnetwork/index>` - Complete function signatures and detailed examples
